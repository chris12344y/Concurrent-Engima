...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Login ID="Login1" runat="server" style="background-color:rgba(51, 51, 51, 0.6); color:white;" BackColor="#403940" BorderColor="#E6E2D8" BorderPadding="4" BorderStyle="Solid" BorderWidth="1px" Font-Names="Verdana" Font-Size="0.8em" ForeColor="White" Height="238px" OnAuthenticate="Login1_Authenticate" Width="567px" UserNameLabelText="Email:" CreateUserText="Register New Account" CreateUserUrl="~/AddUser.aspx" CssClass="footerLink" DisplayRememberMe="False">
