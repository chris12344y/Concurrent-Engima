...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Login ID="Login1" runat="server" BackColor="#F7F6F3" BorderColor="#E6E2D8" BorderPadding="4" BorderStyle="Solid" BorderWidth="1px" Font-Names="Verdana" Font-Size="0.8em" ForeColor="#333333" Height="238px" OnAuthenticate="Login1_Authenticate" Width="567px" UserNameLabelText="Email:" CreateUserText="Register New Account" CreateUserUrl="~/NewUser.aspx">
