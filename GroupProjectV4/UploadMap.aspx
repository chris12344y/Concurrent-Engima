    ...
    <table>
        <tr>
            <td class="content_actual" >
                ...
                <asp:RequiredFieldValidator ID="MapNameValidator" runat="server" ControlToValidate="MapNameTxtBox" ErrorMessage="*" ForeColor="#CC3300" ValidationGroup="mapValidationGroup" ></asp:RequiredFieldValidator>
            </td>
            <td class="content_actual">
            ...
            <td class="content_actual"><asp:Panel ID="frmConfirmation" Visible="False" Runat="server" Height="32px" Width="190px">
            </asp:Panel></td>
        </tr>
        <tr>
            <td class="content_actual">
                <asp:Label ID="UploadMapLabel" runat="server" Text="Upload a map:" CssClass="label_upload"></asp:Label>
                <INPUT ID="mapFile" type="file" NAME="mapFile" runat="server" /><asp:RequiredFieldValidator ID="MapFileValidator" runat="server" ControlToValidate="mapFile" ErrorMessage="*" ForeColor="#CC3300" CssClass="label_upload" ValidationGroup="mapValidationGroup"></asp:RequiredFieldValidator>            </td>
            <td>
                <div id="label_result">
        ...
        <tr>
            <td>
                <asp:Button ID="UploadButton" type="submit" runat="server" Text="Upload" OnClick="UploadButton_Click" CssClass="button" ValidationGroup="mapValidationGroup" />
            </td>
